				...
				<section id="primary" class="page-with-sidebar with-left-sidebar">
					<div class="content">
						...
						<div class="dt-sc-tabs-vertical-container">
							...
							<p><strong>CCcamInfoPhp svn_r257</strong> je PHP statistická aplikace pro PC s vylepšeným webovým rozhraním CCcamu, která pracuje pod Apache serverem. Z toho vyplývá, že v případě spuštění např. pod Windows je nutné instalovat nejdříve XAMPP. CCcamInfoPhp svn_r257 je poslední známá "public" verze cca z roku 2011. Vývoj je v rámci soukromého sektoru. </p>
							<p><u>Výhody a nevýhody CCcamInfoPhp oprotí základnímu webovému rozhraní CCcamu:</u> </p>
								<ul class="dt-sc-lmarg25">
									...
									<li><i class="fa fa-plus size14px margright5px"></i> r257 podporuje automatické obnovení stránky pro načtení dat.</li>
								</ul>
						</div>
						...
						<div class="dt-sc-tabs-vertical-container">
							...
							<div class="dt-sc-tabs-vertical-frame-content">
								<a href="downloads/cccam/tools_software/CCcamInfoPHP/CCcamInfoPhp_r257.zip" target="_blank">CCcamInfoPhp r257</a><br>
							</div>
						</div>
						...
						<div class="dt-sc-tabs-vertical-container">
							...
							<ol class="dt-sc-fancy-list dt-sc-lmarg25 caret-right">
								...
								<li>Zkopívat složku "CCcamInfoPhp_r257" ze staženého souboru do složky "htdocs" ve složce kam jsme instalovali XAMPP</li>
								<li>Přejít do složky "htdocs/CCcamInfoPhp_r257" a nakonfigurovat připojení na server v souboru "config_userspecific.tmpl.php"</li>
