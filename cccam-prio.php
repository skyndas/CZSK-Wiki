					...
					<div class="content">
						...
						<div class="dt-sc-tabs-vertical-container">
							...
							<div class="dt-sc-four-fifth dt-sc-lmarg25">
								<p><strong>Situace 1:</strong> Ignorování pouze podle CAID na všech IDENTech a všech kanálů</p>
								<code>
									P: CAID # Popis 
								</code>
								<p><strong>Situace 2:</strong> Ignorování podle CAID a daného IDENTu</p>
								<code>
									P: CAID:IDENT # Popis 
								</code>
								<p><strong>Situace 3:</strong> Ignorování podle CAID,daného IDENTu a SIDu programu</p>
								<code>
									P: CAID:IDENT:SID # Popis 
								</code>
								<p><strong>Situace 4:</strong> Pokud existují CAID1 a CAID2 pro jeden kanál, je preferované CAID1 před CAID2 </p>
								<code>
									P: CAID1, CAID2 
								</code>
							</div>
