				...
				<section id="primary" class="page-with-sidebar with-left-sidebar">
					<div class="content">
						...
						<div class="dt-sc-tabs-vertical-container">
							...
							<p>Bash je jeden z unixových shellů. Shellové skripty jsou zápisem příkazů do souboru, které bychom jinak zadávali postupně na příkazovém řádku</p>
							<p><u>Umístění scriptů</u></p>
							<p>Bash scripty určené pro práci se CCcam serverem se umisťují do různých adresářů dle využití scriptu a image boxu.</p>
						</div>

						<div class="dt-sc-hr-invisible-very-small"></div>
						<div class="dt-sc-tabs-vertical-container">
							<h4>Zdroje ke studiu</h4>
							<p>Bash script má zde svou vlastní sekci <a href="bash.php">Bash Script</a></p>
						</div>
					</div>
