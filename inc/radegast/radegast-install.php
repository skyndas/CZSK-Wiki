      ...
      <div class="dt-sc-tabs-vertical-container">
        ...
        <table>
          ...
          <tr>
            ...
            <p>Pokud uložíme konfigurační soubor "radegast.cfg" do jiné složky např. "/var/etc" musíme spustit Radegast
              s parametrem "-c"</p>
          </tr>
          <tr>
        ...
        <p>V případě, že se objeví následující chybová hláška po spuštění Radegastu musíme nainstalovat potřebné
          knihovny</p>
        <div>
...
$ sudo dpkg -i libssl0.9.8_0.9.8o-4squeeze14_amd64.deb
        ...
        <div class="dt-sc-lmarg25">
          ...
          <p>Je nutné umístit konfigurační soubor "radegast.cfg" do stejné složky jako binární soubor Radegastu tj.
            "/var/bin"</p>
								<pre class="brush: text;">
./rdgd
								</pre>
          <p><strong>Spuštění se zadáním cesty konfiguračního souboru</strong></p>
          <p>Tímto způsobem spustíme Radegast server pokud se soubor "radegast.cfg" nenachází ve stejné složce s
            binárním souborem.</p>
								<pre class="brush: text;">
