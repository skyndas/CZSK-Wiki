  ...
  <section id="primary" class="page-with-sidebar with-left-sidebar">
    <div class="content">
      ...
      <div class="dt-sc-tabs-vertical-container">
        <p><strong>Radegast</strong> je první emulátor v celé řadě emulátorů od českého tvůrce s nickem "Kindzadza".
          Tento emulátor je psaný v jazyku "Perl" a vznikl kolem roku 2000. Jednalo se o soukromý vývoj pro přátele a
          zdrojové kódy nejsou známy. </p>
        <blockquote class="dt-sc-lmarg type2"><q>Jediná možnost jak získat zdrojové kódy je oslovit Kindzadzu. V
            případě, že by někdo měl zájem o zdrojové kódy s úmyslem pokračovat ve vývoji, myslím že Kindzaza nebude mít
            problém a rád pomůže.</q> <br> <span> skyndas</span></blockquote>
      ...
      <div class="dt-sc-tabs-vertical-container">
        ...
        <p>Radegast umožňuje použít čtečky karet v Triple Dragon a DreamBoxu. Lze je použít přímo na dvě cryptoworks
          karty, třetí kartu umožňuje připojit přes Phoenix - např. originál irdeto2...</p>
        <p>Radegast používá základní soubor klíčů "SoftCam.Key", který najdeme v adresáři /var/keys/SoftCam.Key</p>
        <p>Radegast byl perfektně funkční na velmi stabilních receiverech "Triple Dragon" ale funguje i na
          Dreamboxech.</p>
      ...
      <div class="dt-sc-tabs-vertical-container">
        ...
        <ul class="dt-sc-lmarg25">
          ...
          <li>- Netpilot řeší síťový provoz připojených uživatelů. Uživatelé se přímo nepřipojují na Radegast, ale přes
            Netpilot. (Radegast v3 umí i více klientů na přímo bez Netpilota. Chceme-li přístup k rdgd bez Netpilota, je
            nutné zvětšit počet obsloužených klientů parametrem v konfigu "max clients = xxx").
          </li>
          <li>- Radegast umí fungovat nejenom jako rdgd server (tj, sdilet pomoci rdgd protokolu), ale i jako newcamd
            server (tj, newcamd protokol)
          </li>
          <li>- mod-con-webmin.so - plugin (pro spuštění umístit do stejného adresáře jak Radegast "rdgd" a Radegast ho
            sám spustí).
          </li>
          ...
          <li>- Byla plánovaná i v5.0 s možností instalací rozšiřujících pluginů. Bohužel tuto variantu "Kindzadza"
            započal ve verzi 4, ale vývoj byl s verzí 4.2 ukončen.
          </li>
        </ul>
      </div>
      ...
      <div class="dt-sc-tabs-vertical-container">
        ...
        <div class="dt-sc-lmarg25">
          ...
          <ul class="dt-sc-fancy-list caret-right">
            ...
            <li><strong>dem</strong> - drobná aplikace pro ovládání camd.rdgd na Enigma boxu - jako PMT signální systém
              (Dreambox, Triple Dragon).
            </li>
          </ul>
          ...
          <p><strong>POZNÁMKA: </strong>V některých boxech (zejména Dreambox) je možné, že nebude Radegast pracovat
            správně, protože libcrypto knihovna neobsahuje všechny potřebné znaky. Je dobré aktualizovat knihovnu nebo
            použít přiloženou knihovnu libcrypto.so.0.9.7.</p>
        </div>
      </div>
