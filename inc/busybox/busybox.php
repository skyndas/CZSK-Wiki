...
<div class="container">
  ...
  <section id="secondary-left" class="secondary-sidebar secondary-has-left-sidebar">
    ...
    <?php include("inc/html_content/busybox-menu.php"); ?>
  ...
  <section id="primary" class="page-with-sidebar with-left-sidebar">
    <div class="content">
      ...
      <div class="dt-sc-tabs-vertical-container">
        ...
        <p>Zde uvedené příkazy busyboxu jsou platné příkazy pro boxy enigma a v jednotlivých verzí busyboxu se mohou
          lišit.</p>
      ...
      <div class="dt-sc-tabs-vertical-container">
        ...
        <ul>
          <li><img src="images/icons/icon_file-pdf-24x24.png" class="icon-right-set" alt=""/> <a
              href="downloads/busybox/BusyBox.pdf" title="" target="_blank">Seznam příkazů v BusyBoxu</a></li>
        </ul>
      </div>
    </div>
