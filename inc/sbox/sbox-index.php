  ...
  <section id="primary" class="page-with-sidebar with-left-sidebar">
    <div class="content">
      ...
      <div class="dt-sc-tabs-vertical-container">
        <h4>Datum vzniku</h4>
        <p><strong>sBox</strong> vznikl kolem roku 2009 a je od španělského tvůrce "EDK" ze soukromého sektoru. Zdrojové
          kódy nejsou známy a vývoj stále trvá. </p>
      </div>

      <div class="dt-sc-hr-invisible-very-small"></div>
      <div class="dt-sc-tabs-vertical-container">
        <h4>O sBoxu</h4>
        <p>sBox je softcam jež byl vyvinut speciálně pro poskytování podpory nových karet Nagravision 3. I když se
          specializuje na Nagravision, dnes projekt dospěl tak daleko, že podporuje širokou škálu šifrování Nagravision
          Systeme.</p>
          ...
          <div class="portfolio-thumb float image-container">
            <figure>
              ...
              <div class="image-overlay">
                <a class="zoom" href="images/sbox/sbox_01.png" data-gal="prettyPhoto[gallery]"><span
      ...
      <div class="dt-sc-tabs-vertical-container">
        ...
        <p>Vzhledem k tomu, že sBox je vyvýjen v rámci soukromého sektoru a některé verze nemusí být veřejné, je
          nejkompletnější databáze včech verzí dostupná na následujícím webu:</p>
      ...
      <div class="dt-sc-tabs-vertical-container">
        ...
        <div class="dt-sc-tabs-vertical-frame-content">
          <ul>
            <li><a href="http://www.sboxobs.tk/" title="Fórum španělsky" target="_blank"><img
                  src="images/icons/icon_lang_sp-24x24.png" class="icon-right-set" alt=""/> http://www.sboxobs.tk/</a>
            </li>
            <li><a href="http://www.tododream.com/foro/sbox/" title="Fórum španělsky" target="_blank"><img
                  src="images/icons/icon_lang_sp-24x24.png" class="icon-right-set" alt=""/>
                http://www.tododream.com/foro/sbox/</a></li>
          </ul>
      ...
      <div class="dt-sc-tabs-vertical-container">
        ...
        <div class="dt-sc-tabs-vertical-frame-content">
          <a href="https://twitter.com/SBox_EMU" title="Fórum španělsky" target="_blank"><img
              src="images/icons/icon_lang_sp-24x24.png" class="icon-right-set" alt=""/> https://twitter.com/SBox_EMU</a>
        </div>
      </div>
    </div>
