...
<div class="container">
  ...
  <section id="secondary-left" class="secondary-sidebar secondary-has-left-sidebar">
    ...
    <?php include("inc/html_content/sbox-menu.php"); ?>
      ...
      <div class="dt-sc-tabs-vertical-frame-content">
        <div class="clearfloat">
          ...
          <ul class="dt-sc-fancy-list arrow">
            ...
            <li>New parameters for viaccess cards (see sbox.conf for more info). "Partial"-Support in NA nagra cards
              used (must specify mode = 3)
            </li>
            <li>Improved compatibility with smargo readers V2, you may now fail the V1 ... (reportad fault if you have
              one)
            </li>
          </ul>
          ...
          <p>(emu/cardserver for PowerPC, MIPS, X86 & SH4)</p>
          <ul class="dt-sc-fancy-list arrow">
            <li>Small changes on the server CCcam. He shows some more information on the webif, tab "Entitlements"
              (nagra cards only)
            </li>
          ...
          <p>(emu/cardserver for PowerPC, MIPS, X86 & SH4)</p>
          <ul class="dt-sc-fancy-list arrow">
            <li>(dvbapi) Corregido fallo que provocaba que SBox "interrogase" a la tarjeta más de la cuenta al pasar por
              un canal con caid viaccess/irdeto
            </li>
          </ul>
          ...
          <ul class="dt-sc-fancy-list arrow">
            ...
            <li>(CCcam/NewCamd/Radegast) added support for long ECM (viaccess) using SBox as a client, the server can be
              either as "support" to the card
            </li>
          </ul>
          ...
          <p>(emu/cardserver for PowerPC, MIPS, X86 & SH4)</p>
          <ul class="dt-sc-fancy-list arrow">
            <li>(dvbapi) fixed bug causing that SBox "interrogation" to the card account by passing through a channel
              with caid viaccess/irdeto
            </li>
          </ul>
          ...
          <p>(emu/cardserver for PowerPC, MIPS, X86 & SH4)</p>
          <ul class="dt-sc-fancy-list arrow">
            <li>Added support for OMNIKEY readers. Change the value of reader = 3 and sci = 0. If you have more than one
              reader, you create another slot with sci = 1 and so on. Currently only support these readers mips and x86
              versions.
            </li>
          ...
          <p>(emu/cardserver for PowerPC, MIPS, X86 & SH4)</p>
          <ul class="dt-sc-fancy-list arrow">
            <li>Added support for Conax cards CAS7 married, require the receiver rsa original (thanks to mitega), more
              info in the sbox.conf
            </li>
            <li>Added option 'controlsid', this option may limit the number of channels that can open a card at a time,
              more info in the sbox.conf
            </li>
          </ul>
          ...
          <p>(emu/cardserver for PowerPC, MIPS, X86 & SH4)</p>
          <ul class="dt-sc-fancy-list arrow">
            <li>Fixed some problems with rom110 and is arranged by step if you decide to do also with other rom (fake
              len ecm), this may mean less resets or may not, depending on whether they have been sending such ecm .
            </li>
            <li>Small changes in the client / server CCcam.</li>
            <li>Added more "client-id" for newcamd server. Before the start SBox with the-s response time increased, now
              the time is the same as tearing with-s without it.
            </li>
            <li>Other small changes</li>
          </ul>
          ...
          <p>(emu/cardserver for PowerPC, MIPS, X86 & SH4)</p>
          <ul class="dt-sc-fancy-list arrow">
            <li>SBox upload this version for those of you interested the testeeis. There have been changes in the
              newcamd server to try to achieve greater stability, have also been small changes to the client CCcam. In
              the webinterface has added a little chat.
            </li>
          </ul>
          ...
          <p>(emu/cardserver for PowerPC, MIPS, X86 & SH4)</p>
          <ul class="dt-sc-fancy-list arrow">
            <li>There have been changes in the newcamd server to try to achieve greater stability, have also been small
              changes to the client CCcam. In the webinterface has added a little chat.
            </li>
          </ul>
          ...
          <ul class="dt-sc-fancy-list arrow">
            ...
            <li>Added cccam cardserver support, emm support only for local cards (very very experimental) (see sbox.conf
              and users.sbox for details)
            </li>
          </ul>
