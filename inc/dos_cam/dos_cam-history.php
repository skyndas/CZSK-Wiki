        ...
        <div class="clearfloat">
          ...
          <ul class="dt-sc-fancy-list arrow">
            ...
            <li>- Pincodes können ab jetzt in doscam.cfg unter [pincode] definiert werden
              <ul class="dt-sc-fancy-list caret-right">
                <li>Format: HHHHHHHHHHHHHHHH:XXXX (H=Hexserial, 8-stellig und im Webif unter den Entitlements ablesbar,
                  X=4-stelliger Pin)
                </li>
...
0100:00006A:::4:11000:
            ...
            <li>- Neuer Reader-Parameter "slots", der es bei einer Quadmouse, MCR und ähnlichen Geräten überflüssig
              macht, für jeden Slot einen Reader zu definieren
              <ul class="dt-sc-fancy-list caret-right">
...
group = 1
            ...
            <li>- gbox-Protokoll angepasst, damit es weiterhin mit der OSCam kompatibel ist (long ecm support und
              gbox_my_password unter [gbox] statt [reader])
            </li>
