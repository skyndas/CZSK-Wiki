						...
						<div class="dt-sc-tabs-vertical-container">
							...
							<div class="dt-sc-tabs-vertical-frame-content">
								...
								<div class="dt-sc-lmarg25">
									...
									<p><u>Popis</u></p>
									<p>Po instalaci budou dostupné všechny potřebné soubory. Soubor "CCcam.channelinfo, CCcam.providers" bude nutné updatovat. CCcam. cfg je v základním nastavení tj. CCcam server pracuje pouze s lokálními kartami <a href="index.php?category=cccam&page=cccam-config"> Více o CCcam.cfg <span class="fa fa-long-arrow-right"> </span> </a>.</p>
								</div>
