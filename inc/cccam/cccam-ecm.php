  ...
  <section id="primary" class="page-with-sidebar with-left-sidebar">
    <div class="content">
      ...
      <div class="dt-sc-tabs-vertical-container">
        ...
        <p>Soubor s názvem <strong>ecm.info</strong> najdeme v pracovní adresáři boxu. Nejčastěji to je
          <strong>/tmp</strong>. Jedná se o soubor ve kterém se nacházejí informace o dekódovaném programu na který se
          právě díváte. Vzhledem k tomu, že ve webovém rozhraní není žádné info o DVB-Api, najdeme alespoň několik
          informací v tomto souboru.</p>
