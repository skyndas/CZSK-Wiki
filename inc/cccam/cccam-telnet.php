...
Of course you also need to be in the correct location so you change it with this command
	...
	cd /usr/bin
        ...
        <p><span class="fa icon-icon_light"></span> <strong>Tip: Jak zobrazit pouze běžící proces CCcamu v
            telnetu:</strong></p>
        <div class="dt-sc-one dt-sc-lmarg25">
								<pre>
ps |grep CCcam
...
ps aux|grep CCcam 
        ...
        <p><span class="fa icon-icon_light"></span> <strong>Tip: Jak editovat CCcam.cfg pomocí shell příkazů:</strong>
        </p>
        <div class="dt-sc-one dt-sc-lmarg25">
								<pre>
ADD USER :
...
ADD NLINE :
	...
	echo "N: host port user pass 01 02 03 04 05 06 07 08 09 10 11 12 13 14" >>/etc/CCcam.cfg  
        ...
        <p>Osobně raději používám "Nano Editor" pro editaci textových souborů. S "Nano Editorem" máme plnou kontrolu nad
          celým textovým obsahem. Editor není součástí receiverů a musí se doinstalovat</p>
      </div>
