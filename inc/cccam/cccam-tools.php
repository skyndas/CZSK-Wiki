  ...
  <section id="primary" class="page-with-sidebar with-left-sidebar">
    <div class="content">
      ...
      <div class="dt-sc-tabs-vertical-container">
        ...
        <p><strong>CCcamInfoPhp v1.02</strong> je PHP aplikace pro PC s vylepšeným webovým rozhraním CCcamu, která
          pracuje pod Apache serverem. Z toho vyplývá, že v případě spuštění např. pod Windows je nutné instalovat
          nejdříve XAMPP.</p>
        ...
        <ul class="dt-sc-lmarg25">
          ...
          <li><i class="fa fa-minus size14px margright5px"></i> v1.02 stále nepodporuje automatické obnovení stránky pro
            načtení dat.
          </li>
        </ul>
      </div>
      ...
      <div class="dt-sc-tabs-vertical-container">
        ...
        <div class="dt-sc-tabs-vertical-frame-content">
          <a href="downloads/cccam/tools_software/CCcamInfoPHP/CCcamInfoPhp_v1.02.zip" target="_blank">CCcamInfoPhp
            v1.02</a><br>
        </div>
      </div>
      ...
      <div class="dt-sc-tabs-vertical-container">
        ...
        <ol class="dt-sc-fancy-list dt-sc-lmarg25 caret-right">
          ...
          <li>Zkopívat složku "CCcamInfoPhp_v1.02" ze staženého souboru do složky "htdocs" ve složce kam jsme
            instalovali XAMPP
          </li>
              ...
              <div class="portfolio-thumb">
                <figure>
                  ...
                  <div class="image-overlay">
                    <a class="zoom" href="images/cccam/cccam_08.png" data-gal="prettyPhoto[gallery]"><span
        ...
        <p>Vyplníme potřebné údaje a klikneme na "Save configuration". CCcamInfoPhp se připojí na CCcam a zobrazí se
          webové rozhraní CCcamu ve vylepšené podobě.</p>
        <div class="textcontainer">
          <div class="portfolio-container">
            <div style="width: 390px;" class="portfolio number_text">
              <!-- **portfolio-thumb - Starts** -->
              <div class="portfolio-thumb">
                <figure>
                  ...
                  <div class="image-overlay">
                    <a class="zoom" href="images/cccam/cccam_09.png" data-gal="prettyPhoto[gallery]"><span
                        class="fa fa-search"></span></a>
                    <div class="portfolio-content">
        ...
        <div class="dt-sc-lmarg25">
          <p>Pro manuální nastavení připojení k CCcam serveru otevřeme soubor "config.php". Soubor obsahuje i nápovědu o
            zadávání konfigurace připojení.</p>
          <p>Na internetu jsem našel volný přístup k webovému rozhraní CCcamu, které je dlouhodobě přístupné bez
            logovacích údajů. Na tomto spojení si můžeme ukázat nastavení CCcamInfoPhp. Do souboru "config.php" přidáme
            následující řádek:</p>
								<pre class="brush: text;">
$CCCamWebInfo[] = array("telephone.dyndns.info","16001");
								</pre>
          <p>CccamInfoPhp v1.02 obshuje asi nějakou programovou chybu, protože v případě, že chceme přidat více než
            jeden server přes webové rozhraní CCcamInfoPhp, vyskočí chyba php kódu. Z toho důvodu je důležité umět i
            přidat připojení na server manuálně.</p>
          <div class="textcontainer">
            <div class="portfolio-container">
              <div style="width: 390px; padding-left: 0;" class="portfolio number_text">
                ...
                <div class="portfolio-thumb">
                  <figure>
                    ...
                    <div class="image-overlay">
                      <a class="zoom" href="images/cccam/cccam_13.png" data-gal="prettyPhoto[gallery]"><span
                          class="fa fa-search"></span></a>
                      <div class="portfolio-content">
            ...
            <div style="width: 390px;" class="portfolio number_text">
              ...
              <div class="portfolio-thumb">
                <figure>
                  ...
                  <div class="image-overlay">
                    <a class="zoom" href="images/cccam/cccam_12.png" data-gal="prettyPhoto[gallery]"><span
                        class="fa fa-search"></span></a>
                    <div class="portfolio-content">
            ...
            <div style="width: 390px;" class="portfolio number_text">
              ...
              <div class="portfolio-thumb">
                <figure>
                  ...
                  <div class="image-overlay">
                    <a class="zoom" href="images/cccam/cccam_10.png" data-gal="prettyPhoto[gallery]"><span
                        class="fa fa-search"></span></a>
                    <div class="portfolio-content">
            ...
            <div style="width: 390px;" class="portfolio number_text">
              ...
              <div class="portfolio-thumb">
                <figure>
                  ...
                  <div class="image-overlay">
                    <a class="zoom" href="images/cccam/cccam_11.gif" data-gal="prettyPhoto[gallery]"><span
                        class="fa fa-search"></span></a>
                    <div class="portfolio-content">
