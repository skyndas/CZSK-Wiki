				...
				<section id="primary" class="page-with-sidebar with-left-sidebar">
					<div class="content">
						...
						<div class="dt-sc-tabs-vertical-container">
							...
							<a href="http://www.mediafire.com/download/4w3wej3igi6jj85/TNTsat+Oscam+9580+inc+settings.rar">2. TNTSat AES Key</a><br><br>
											...
											<div class="portfolio-thumb">
												<figure>
													...
													<div class="image-overlay">
														<a class="zoom" href="images/cards/french/tntsat.jpg" data-gal="prettyPhoto[gallery]"><span class="fa fa-search"></span></a>
							...
							<!-- START DECODE AES KEY -->
								...
								<div style="width:100%;text-align:center;padding-bottom: 52px;">
									<button type="button" title="Decode" id="b64-decode0" style="margin:0px 15px;"><span><span>Dekódovat klíče</span></span></button>
								</div>
								...
								<div style="width:100%;text-align:center;padding-bottom: 52px;">
									<button type="button" title="Decode" id="b64-decode1" style="margin:0px 15px;"><span><span>Dekódovat klíče</span></span></button>
								</div>
								<script type="text/javascript">
								...
								<div style="width:100%;text-align:center;padding-bottom: 52px;">
									<button type="button" title="Decode" id="b64-decode2" style="margin:0px 15px;"><span><span>Dekódovat klíče</span></span></button>
								</div>
								<script type="text/javascript">
